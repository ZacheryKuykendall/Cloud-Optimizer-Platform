...
Virtual Network Gateways and Local Network Gateways.
"""
...
class AzureVpnClient:
    ...
    async def create_local_network_gateway(
        ...
        Args:
            ...
            resource_group: Resource group name
            location: Azure region
            gateway_ip: Public IP of the remote gateway
            address_spaces: List of remote address spaces
            asn: Optional ASN for BGP
    ...
    async def get_vpn_connection(
        ...
        try:
            ...
            return VpnConnection(
                ...
                aws_gateway=None,  # Will be set by manager
                tunnels=tunnels,
