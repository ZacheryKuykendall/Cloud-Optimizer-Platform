"""Data models for AWS-GCP VPN connections.

This module provides data models for managing Site-to-Site VPN connections
between AWS Virtual Private Gateways and Google Cloud VPN Gateways.
"""
...
class AwsVpnGateway(BaseModel):
    """AWS Virtual Private Gateway configuration."""
    vpn_gateway_id: str
    vpc_id: str
